...
| ~~T29 Phase 2~~ | ~~Text-pattern detection~~ ✅ Shipped (fast-NCC template-matching `detectTextTiling()` fallback for letter-form tiled marks, wired into the tile-fill confirm flow) | Done |
